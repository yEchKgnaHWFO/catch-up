...
c.Other()}};this.subfolderDepth=a.trackSubfolderDepth?a.trackSubfolderDepth:1;this.target=a.targetType?a.targetType:"usual";this.url=a.url?a.url:f(location.href);this.referUrl=a.referUrl?a.referUrl:f(document.referrer);this.adSrTag=function(){for(var a=location.search.substring(1).split("\x26"),b=0;b<a.length;b++){var c=a[b].split("\x3d");if("AD_SR"==c[0]||"ad_sr"==c[0])return c[1]}return""}();a.cf_uid&&(this.cf_uid=a.cf_uid);if(a.sp_variable)for(var d=a.sp_variable.split(","),e=0;e<d.length&&4>e;e++)null!=
